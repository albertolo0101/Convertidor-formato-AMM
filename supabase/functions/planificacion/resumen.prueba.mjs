...
console.log('\nventana de dias');
{
  ...
  comparar('del mas reciente al mas antiguo',
    [r.dias[0].fecha, r.dias[9].fecha], ['2026-09-24', '2026-09-15']);
  comparar('los fines de semana cuentan como dias',
    r.dias.map(function (d) { return d.fecha; }).includes('2026-09-19'), true);
...
{
  const r = resumir([
    sectores(9, 'lavado', ['C4-A1']),
    sectores(10, 'lavado', ['C4-A2']),
    sectores(40, 'lavado', ['C4-B1']),
  ], AHORA);
  comparar('el dia 9 entra', r.ultimo.lavado['C4-A1'], '2026-09-15');
  comparar('el dia 10 ya quedo afuera', 'C4-A2' in r.ultimo.lavado, false);
